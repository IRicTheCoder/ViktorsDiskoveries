...
namespace VikDisk.SRML
{
	...
	public static class LanguageUtils
	{
		...
		// The current language to prevent the load for happening everytime a scene changes
		...
		internal static void SetTranslations(Assembly yourAssembly = null)
		{
			if (firstLock)
			{
				firstLock = false;
		...
		internal static void LanguageChange(MessageDirector dir)
		{
			SetTranslations();
		}
	}
