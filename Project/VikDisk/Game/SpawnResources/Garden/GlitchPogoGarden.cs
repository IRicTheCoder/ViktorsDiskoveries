...
{
	public class GlitchPogoGarden : TreeGardenResource
	{
		public override string Name => "GardenGlitchPogo";

		protected override bool IsDeluxe => false;

		protected override Identifiable.Id PlantID => Identifiable.Id.GLITCH_BUG_REPORT; // TODO: Change back

		public override SpawnResource.Id ID => Enums.SpawnResources.GLITCH_POGOFRUIT_TREE;
		...
		protected override int MinBonusSelections => 8;
